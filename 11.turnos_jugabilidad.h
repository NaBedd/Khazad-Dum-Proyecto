...
void turno_heroes(sala *sala_actual_heroes, mapaGrafo &mapa) // Turno de heroes
{
    ...
    {
        sala_actual_heroes = movimiento_heroes(sala_actual_heroes, mapa);
        break;
    }
...
void juego(int &turno)
{
    ...
    while (!acabo_juego)
    {
        ...
        cout << "--- TURNO " << turno << " ---";
        turno_heroes(sala_actual_heroes, grafo);
