...
void AñadirSalaALista(Lista_mapa &lista_mapa, string &nombre, int &distancia)
{
    ...
    if (nuevaSala)
    {
        ...
        else
        {
            ...
            {
                if (otraSala != nuevaSala)
                { // Evitar crear adyacencia consigo misma
...
void MostrarMapa(const Lista_mapa &lista_mapa)
{
    ...
    while (actual != nullptr)
    {
        cout << "Sala: " << actual->nombreSala << endl;
        cout << "Distancia entre salas " << actual->nombreSala << " y " << actual->siguientesala->nombreSala << "es de: " << actual->distancia_sala << endl;
        cout << "Cantidad de Orcos en la sala: " << actual->nombreSala << ": " << actual->cantidadOrcos << endl;
...
void EliminarSala(Lista_mapa &lista_mapa, string nombresala)
{
    ...
    else
    {
        ...
        if (anterior->siguientesala != nullptr)
        { // Actualizar la distancia de la sala anterior
